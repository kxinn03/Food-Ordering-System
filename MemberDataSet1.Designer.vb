...
Partial Public Class MemberDataSet
    ...
    Partial Public Class MemberDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddMemberRow(ByVal Id As Integer, ByVal Name As String, ByVal Username As String, ByVal Password As String, ByVal Email As String, ByVal PhoneNumber As String) As MemberRow
            Dim rowMemberRow As MemberRow = CType(Me.NewRow,MemberRow)
            Dim columnValuesArray() As Object = New Object() {Id, Name, Username, Password, Email, PhoneNumber}
    ...
    Partial Public Class MemberTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Member] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_N"& _ 
                "ame) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password)"& _ 
                " AND ([Email] = @Original_Email) AND ([PhoneNumber] = @Original_PhoneNumber))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Member] ([Id], [Name], [Username], [Password], [Email], [Phone"& _ 
                "Number]) VALUES (@Id, @Name, @Username, @Password, @Email, @PhoneNumber);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELEC"& _ 
                "T Id, Name, Username, Password, Email, PhoneNumber FROM Member WHERE (Id = @Id)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Member] SET [Id] = @Id, [Name] = @Name, [Username] = @Username, [Pa"& _ 
                "ssword] = @Password, [Email] = @Email, [PhoneNumber] = @PhoneNumber WHERE (([Id]"& _ 
                " = @Original_Id) AND ([Name] = @Original_Name) AND ([Username] = @Original_Usern"& _ 
                "ame) AND ([Password] = @Original_Password) AND ([Email] = @Original_Email) AND ("& _ 
                "[PhoneNumber] = @Original_PhoneNumber));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, Name, Username, Password, E"& _ 
                "mail, PhoneNumber FROM Member WHERE (Id = @Id)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, Name, Username, Password, Email, PhoneNumber FROM dbo.Member"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Id As Integer, ByVal Original_Name As String, ByVal Original_Username As String, ByVal Original_Password As String, ByVal Original_Email As String, ByVal Original_PhoneNumber As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Id As Integer, ByVal Name As String, ByVal Username As String, ByVal Password As String, ByVal Email As String, ByVal PhoneNumber As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Id As Integer, ByVal Name As String, ByVal Username As String, ByVal Password As String, ByVal Email As String, ByVal PhoneNumber As String, ByVal Original_Id As Integer, ByVal Original_Name As String, ByVal Original_Username As String, ByVal Original_Password As String, ByVal Original_Email As String, ByVal Original_PhoneNumber As String) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Name As String, ByVal Username As String, ByVal Password As String, ByVal Email As String, ByVal PhoneNumber As String, ByVal Original_Id As Integer, ByVal Original_Name As String, ByVal Original_Username As String, ByVal Original_Password As String, ByVal Original_Email As String, ByVal Original_PhoneNumber As String) As Integer
            Return Me.Update(Original_Id, Name, Username, Password, Email, PhoneNumber, Original_Id, Original_Name, Original_Username, Original_Password, Original_Email, Original_PhoneNumber)
        End Function
    End Class
